...
class  CashTransaction(BaseModel):
    ...
    status =  models.CharField(max_length=15, choices=StatusType.choices, default='pending')
...
class Transfer(BaseModel):
    source_account = models.ForeignKey('Account', on_delete=models.PROTECT, related_name= 'source_account')
...
class TransactionHistory(BaseModel):
    ...
    type =  models.CharField(max_length=10, choices=TransactionType.choices)
    transfer_account = models.ForeignKey('Account',related_name= 'transfer_account', on_delete=models.PROTECT, null=True,blank=True)
